        ...
        {#if object}
            ...
            <div class="space-y-3">
                ...
                <div class="space-y-2 px-1">
                    ...
                    />
                    <div class="text-xs text-muted-foreground font-mono flex items-center gap-1">
                        <span>ID:</span>
            ...
            {#if object instanceof Types.BNode3D}
                <div class="space-y-3">
                    <div class="flex items-center gap-2 px-1">
                        ...
                        <h3 class="font-medium text-sm text-foreground">Transform</h3>
                    </div>
            ...
            {#if object instanceof Types.BPart}
                <div class="space-y-3">
                    <div class="flex items-center gap-2 px-1">
                        ...
                        <h3 class="font-medium text-sm text-foreground">Part</h3>
                    </div>
            ...
            {#if object instanceof Types.BUI}
                <div class="space-y-3">
                    <div class="flex items-center gap-2 px-1">
                        ...
                        <h3 class="font-medium text-sm text-foreground">UI Layout</h3>
                    </div>
            ...
            {#if object instanceof Types.BContainerUI}
                <div class="space-y-3">
                    <div class="flex items-center gap-2 px-1">
                        ...
                        <h3 class="font-medium text-sm text-foreground">Container</h3>
                    </div>
            ...
            {#if object instanceof Types.BTextUI}
                <div class="space-y-3">
                    <div class="flex items-center gap-2 px-1">
                        ...
                        <h3 class="font-medium text-sm text-foreground">Text</h3>
                    </div>
            ...
            {#if object instanceof Types.BButtonUI}
                <div class="space-y-3">
                    <div class="flex items-center gap-2 px-1">
                        ...
                        <h3 class="font-medium text-sm text-foreground">Button</h3>
                    </div>
            ...
            {#if object instanceof Types.BScript}
                <div class="space-y-3">
                    <div class="flex items-center gap-2 px-1">
                        ...
                        <h3 class="font-medium text-sm text-foreground">Script</h3>
                    </div>
            ...
            {#if object instanceof Types.BConstraint}
                <div class="space-y-3">
                    <div class="flex items-center gap-2 px-1">
                        ...
                        <h3 class="font-medium text-sm text-foreground">Constraint</h3>
                    </div>
            ...
            <div class="space-y-3">
                <div class="flex items-center gap-2 px-1">
                    ...
                    <h3 class="font-medium text-sm text-muted-foreground">Debug Info</h3>
                </div>
